        ...
        for (int y = 6; y < lines.size(); y++) {
            ...
            for (int x = 0; x < line.length(); x++) {
                ...
                grid.setBlock(x, relY, new BlockSolid(BlockTypes.BARRIER, new Location(x * Game.BLOCK_SIZE, relY * Game.BLOCK_SIZE)));
                    ...
                    grid.setBlock(x, relY, new BlockSolid(BlockTypes.WATER_TOP, new Location(x * Game.BLOCK_SIZE, relY * Game.BLOCK_SIZE)));

            }else if (line.charAt(x) == 'O') {
                    grid.setBlock(x, relY, new BlockSolid(BlockTypes.WATER_BOTTOM, new Location(x * Game.BLOCK_SIZE, relY * Game.BLOCK_SIZE)));
