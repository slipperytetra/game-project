...
public class QuadTreeOld {
    ...
    private QuadTreeOld northEast, northWest, southEast, southWest;

    public GameObject focus;

    public QuadTreeOld(CollisionBox boundary, int capacity) {
