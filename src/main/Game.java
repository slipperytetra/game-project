...
public class Game extends GameEngine {
    ...
    public void paintComponent() {
        ...
        for (int bX = 0; bX < lvlManager.DEMO.getSize(); bX++) {
            for (int bY = 0; bY < lvlManager.DEMO.getSize(); bY++) {
                Block b = lvlManager.DEMO.getBlockGrid().getBlockAt(bX, bY);
                if (b != null) {
                    ...
                    this.drawSolidRectangle(b.getLocation().getX() * BLOCK_SIZE, b.getLocation().getY() * BLOCK_SIZE, BLOCK_SIZE, BLOCK_SIZE);
                }
            }
        }
